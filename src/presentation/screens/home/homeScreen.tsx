...
const HomeScreen = () => {
  ...
  const { loading, nowPlaying, upcoming, topRated, popular, loadMorePopular } = useMovies();
  ...
  return (
    <ScrollView>
      <View style={{ marginTop: top + 20, paddingBottom: 20 }}>
        ...
        <HorizontalCarrousel movies={popular} title="Popular" loadNextPage={loadMorePopular} />
